...
$_SESSION['currentpagelimit']=$_SESSION['TotalRecordsOnAdminTopicsPage'];
$objPlTag=new PlTags();
$pages = new Paginator();
$num_rows=$objPlTag->PlTotalTags();
//Pagination
$style="
    <!--Paging-->
        <style type='text/css'>
...
$limit=$pages->limit;
$output=$objPlTag->PlGetAllTagsOnAdminPage($limit);
if($num_rows>0)
{
...
$menuLink="<a href='AddTag.php'>Add Tag</a>";
$pageTitle="Tags Information";
$contentTitle="Tags Details";
$contentData=  ob_get_contents(); //Stroging the buffered data in to $contentData
ob_clean();
