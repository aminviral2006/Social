...
//Pagination
$_SESSION['currentpagelimit']=$_SESSION['TotalRecordsOnAdminMemberPage'];
$pages = new Paginator();
$num_rows=$objPlMemberRegistration->PlTotalRecords();
$style="
    <!--Paging-->
        <style type='text/css'>
        .paginate {
...
$limit=$pages->limit;
$output=$objPlMemberRegistration->PlGetAllMembersListOnAdminPage($limit);
if($num_rows>0)
{
...
$menuLink="<a href='SearchMember.php'>Search Member </a>";
