...
<form name="frmSearchStuff" id="frmSearchStuff" method="get" action="CategorySearchResult.php">
    <table align="center"
        ...
        <tr>
            ...
            <td>
                <!--<input type="text" name="txtsearch" id="txtsearch" />-->
                 <div class="main">
                    <div id="holderr">
                        Search Category :<input type="text" id="txtsearch" name="txtsearch" tabindex="0" size="29" OnKeyPress="return disableEnterKey(event);"/>
                        <img src="SuggestCategory/images/loading.gif" id="loading" alt=""/> <input type="submit" name="submit" id="submit" value="Search"/>
                    </div>
                    <div id="ajax_response_category"></div>
                </div>
            </td>
            <td>
