        ...
        <div id="dvMain" align="center">
            ...
            <div id="dvData">
                <form id="frmLogin" name="frmLogin" method="post" action="checkmemberlogin.php">
                    <table id="memberlogin" align="center" border='0' dir='rtl' cellpadding="5px" cellspacing="5px"
           style='font-size:12px;background-color: #FFCC66;height:20px;border: 1px solid black;'>
                        <tr>
                            <th colspan="3">Administrator Login <hr/></th>
                        </tr>
                        <tr>
                            <td><input type="text" id="txtusername" name="txtusername" style="width:200px"/></td>
                            <td>:</td>
                            <td>User Name</td>
                        </tr>
                        <tr>
                            <td><input type="password" id="txtpassword" name="txtpassword" style="width:200px"/></td>
                            <td>:</td>
                            <td>Password</td>
                        </tr>
                        <tr>
