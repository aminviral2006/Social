...
$pages = new Paginator();
$num_rows=$objPlStuff->PlTotalUnhandledReportViolation();
$style="
    <!--Paging-->
        <style type='text/css'>
        .paginate {
...
$output=$objPlStuff->PlDisplayAllReportViolation($limit);
if($num_rows>0)
{
...
$menuLink="<a href='DisplayHandledViolation.php?page=1&ipp=".$_SESSION['TotalRecordsOnAdminStuffPage']."'>Handled Report Violation List</a>";
$pageTitle="Unhandled Report Violation List";
$contentTitle="Unhandled Report Violation List";
