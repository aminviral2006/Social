...
$num_rows=0;
if(isset($_REQUEST['id']))
    $num_rows=$objPlBrowseStuff->PlGetAllMemberBookmarkedStuffTotal($_REQUEST['id'],$_SESSION['tag'], $filter);
else
    $num_rows=$objPlBrowseStuff->PlGetAllMemberBookmarkedStuffTotal($_SESSION['memberid'],$_SESSION['tag'], $filter);
if($num_rows>0)
{
...
$output = $objPlBrowseStuff->PlGetAllMemberBookmarkedStuff($memberid,$limit,$_SESSION['tag'],$filter);
/* Browsing Stuff Ends Here */

/* Display All Tags */
$objPlTag=new PlTags();
$alltagslist=$objPlTag->PlDisplayAllTagsOnMemberBookmarkedStuffPage();
/* Ends here*/
                ...
                <div id="dvProfileDetailSection">
                    <div id="dvStuffDetailSection">
                        <div id="dvSort">
                            ...
                            ?>
                            <a href="Bookmarks.php?page=1&ipp=<?php echo $_SESSION['TotalRecordsOnMemberStuffPage']; ?>&<?php echo $defaulttag; ?>&filter=active discussion">Active Discussion</a>
                            <a href="Bookmarks.php?page=1&ipp=<?php echo $_SESSION['TotalRecordsOnMemberStuffPage']; ?>&<?php echo $defaulttag; ?>&filter=active discussion">Popularity</a>
                            <a href="#">Rating</a>
                            <a href="Bookmarks.php?page=1&ipp=<?php echo $_SESSION['TotalRecordsOnMemberStuffPage']; ?>&<?php echo $defaulttag; ?>">Added</a>
                            :Sort
                        </div>
                        <div id="dvFilter">
                            <a href="Bookmarks.php?page=1&ipp=<?php echo $_SESSION['TotalRecordsOnMemberStuffPage']; ?>&<?php echo $defaulttag; ?>&filter=created">Created</a>
                            <a href="Bookmarks.php?page=1&ipp=<?php echo $_SESSION['TotalRecordsOnMemberStuffPage']; ?>&<?php echo $defaulttag; ?>">None</a>
                            :Filter
                        </div>
                        <div id="dvTopPaging">
                            <?php
                        ...
                        <div id="dvStuffsTitle">
                            <?php
                                if(isset($_REQUEST['profileid']))
                                    ...
                                    echo "<a href='Stuffs.php?page=1&ipp=".$_SESSION['TotalRecordsOnMemberStuffPage']."&id=".$_REQUEST['id']."&member=".$_REQUEST['member']."&tag=All'>Stuff</a>";
                            ?>
                        </div>
