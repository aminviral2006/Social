...
$num_rows=0;
if(isset($_REQUEST['id']))
    $num_rows=$objPlBrowseStuff->PlGetAllMemberFriendsStuffTotal($_REQUEST['id'],$_SESSION['tag'], $filter);
else
    $num_rows=$objPlBrowseStuff->PlGetAllMemberFriendsStuffTotal($_SESSION['memberid'],$_SESSION['tag'], $filter);
if($num_rows>0)
{
...
if(isset($_REQUEST['id']))
    $output = $objPlBrowseStuff->PlGetAllMemberFriendsStuff($_REQUEST['id'],$limit,$_SESSION['tag'],$filter);
else
    $output = $objPlBrowseStuff->PlGetAllMemberFriendsStuff($_SESSION['memberid'],$limit,$_SESSION['tag'],$filter);
/* Browsing Stuff Ends Here */

/* Display All Tags */
$objPlTag=new PlTags();
$alltagslist=$objPlTag->PlDisplayAllTagsOnMemberFriendsStuffPage();
/* Ends here*/
                ...
                <div id="dvProfileDetailSection">
                    <div id="dvStuffDetailSection">
                        <div id="dvSort">
                            ...
                            ?>
                            <a href="FriendsStuff.php?page=1&ipp=<?php echo $_SESSION['TotalRecordsOnMemberStuffPage']; ?>&<?php echo $defaulttag; ?>&filter=active discussion">Active Discussion</a>
                            <a href="FriendsStuff.php?page=1&ipp=<?php echo $_SESSION['TotalRecordsOnMemberStuffPage']; ?>&<?php echo $defaulttag; ?>&filter=active discussion">Popularity</a>
                            <a href="#">Rating</a>
                            <a href="FriendsStuff.php?page=1&ipp=<?php echo $_SESSION['TotalRecordsOnMemberStuffPage']; ?>&<?php echo $defaulttag; ?>">Added</a>
                            :Sort
                        </div>
                        <div id="dvFilter">
                            <a href="FriendsStuff.php?page=1&ipp=<?php echo $_SESSION['TotalRecordsOnMemberStuffPage']; ?>&<?php echo $defaulttag; ?>&filter=created">Created</a>
                            <a href="FriendsStuff.php?page=1&ipp=<?php echo $_SESSION['TotalRecordsOnMemberStuffPage']; ?>&<?php echo $defaulttag; ?>">None</a>
                            :Filter
                        </div>
                        <div id="dvTopPaging">
                            <?php
                        ...
                        <div id="dvStuffsTitle">
                            <?php
                                if(isset($_REQUEST['profileid']))
                                    echo "<a href='Stuffs.php?page=1&ipp=".$_SESSION['TotalRecordsOnMemberStuffPage']."&profileid=".$_REQUEST['profileid']."&member=".$_REQUEST['member']."&tag=All'>Stuff</a>";
                                else
                                    echo "<a href='Stuffss.php?page=1&ipp=".$_SESSION['TotalRecordsOnMemberStuffPage']."&id=".$_REQUEST['id']."&member=".$_REQUEST['member']."&tag=All'>Stuff</a>";
                            ?>
                        </div>
                        <div id="dvStuffsList"></div>
                    </div>
                    <div id="dvBookmarks">
                        <div id="dvBookmarksTitle">
                            <?php
                                if(isset($_REQUEST['profileid']))
                                    ...
                                    echo "<a href='Bookmarks.php?page=1&ipp=".$_SESSION['TotalRecordsOnMemberStuffPage']."0&id=".$_REQUEST['id']."&member=".$_REQUEST['member']."&tag=All'>Bookmarks</a>";
                            ?>
                        </div>
