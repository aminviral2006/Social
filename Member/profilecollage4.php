            ...
            for($j=1;$j<=$maxcols;$j++)
            {
                ...
                if( $cnt == $size21 || $cnt == $size22 || $cnt == $size23 || $cnt == $size24 || $cnt == $size25 || $cnt == $size26 || $cnt == $size27 || $cnt == $size28 || $cnt == $size29 || $cnt == $size210 || $cnt == $size211 || $cnt == $size212 || $cnt == $size213 || $cnt == $size214 || $cnt == $size215 || $cnt == $size216 || $cnt == $size217 || $cnt == $size218 || $cnt == $size219 || $cnt == $size220 || $cnt == $size221 || $cnt == $size222 || $cnt == $size223 || $cnt == $size224 || $cnt == $size225 || $cnt == $size226 || $cnt == $size227 || $cnt == $size228 || $cnt == $size229 || $cnt == $size230)
                {
                    $output.="<td colspan='2' width='30px' height='30px' valign='top'>";
                        ...
                        {
                            $output.="<a class='borderit' href='../Stuff/StuffDetail.php?stuffid=".$rows[$index]['StuffID']."' title='".$rows[$index]['Title']."'><img src='Stuff/StuffImages/size2/".$rows[$index]['ImagePath']."' style='height:28px;width:58px;' VSPACE='0' HSPACE='0' alt='img'></a>";
                            $index++;
                        }
                        else
                            $output."&nbsp;</td>";
                ...
                if( $cnt == $size31 || $cnt == $size32 || $cnt == $size33 || $cnt == $size34 || $cnt == $size35 || $cnt == $size36 || $cnt == $size37 || $cnt == $size38 || $cnt == $size39 || $cnt == $size310 || $cnt == $size311 || $cnt == $size312 || $cnt == $size313 || $cnt == $size314 || $cnt == $size315 || $cnt == $size316 || $cnt == $size317 || $cnt == $size318 || $cnt == $size319 || $cnt == $size320 || $cnt == $size321 || $cnt == $size322 || $cnt == $size323 || $cnt == $size324 || $cnt == $size325 || $cnt == $size326 || $cnt == $size327 || $cnt == $size328 || $cnt == $size329 || $cnt == $size330)
                {
                    $output.="<td rowspan='2'  width='30px' height='30px' valign='top'>";
                        if(isset($rows[$index]['ImagePath']))
                        {
                            $output.="<a class='borderit' href='../Stuff/StuffDetail.php?stuffid=".$rows[$index]['StuffID']."' title='".$rows[$index]['Title']."'><img src='Stuff/StuffImages/size3/".$rows[$index]['ImagePath']."' style='min-height:60px;width:28px;' VSPACE='0' HSPACE='0' alt='img'></a>";
                            $index++;
                        }
                        else
                            $output."&nbsp;</td>";
                ...
                if( $cnt == $size41 || $cnt == $size42 || $cnt == $size43 || $cnt == $size44 || $cnt == $size45 || $cnt == $size46 || $cnt == $size47 || $cnt == $size48 )
                {
                    $output.="<td colspan='2' rowspan='2'  width='30px' height='30px' valign='top'>";
                        if(isset($rows[$index]['ImagePath']))
                        {
                            $output.="<a class='borderit' href='../Stuff/StuffDetail.php?stuffid=".$rows[$index]['StuffID']."' title='".$rows[$index]['Title']."'><img src='Stuff/StuffImages/size4/".$rows[$index]['ImagePath']."' style='height:58px;width:58px;' VSPACE='0' HSPACE='0' alt='img'></a>";
                            $index++;
                        }
                        else
                            $output."&nbsp;</td>";
                ...
                /*if($cnt == $size5)
                {
                    $output.="<td colspan='4' rowspan='4'  width='30px' height='30px' valign='top'>";
                        if(isset($rows[$index]['ImagePath']))
                        {
                            $output.="<a class='borderit' href='../Stuff/StuffDetail.php?stuffid=".$rows[$index]['StuffID']."' title='".$rows[$index]['Title']."'><img src='Stuff/StuffImages/size5/".$rows[$index]['ImagePath']."' style='height:123px;width:128px;' VSPACE='0' HSPACE='0' alt='img'></a>";
                            $index++;
                        }
                        else
                            $output."&nbsp;</td>";
                ...
                else
                {
                    $output.="<td  width='30px' height='30px' valign='top'>";
                        if(isset($rows[$index]['ImagePath']))
                        {
                            $output.="<a class='borderit' href='../Stuff/StuffDetail.php?stuffid=".$rows[$index]['StuffID']."' title='".$rows[$index]['Title']."'><img src='Stuff/StuffImages/size1/".$rows[$index]['ImagePath']."' style='height:28px;width:28px;' VSPACE='0' HSPACE='0' alt='img' ></a>";
