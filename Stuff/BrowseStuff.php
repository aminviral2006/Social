...
if(isset($_REQUEST['filter']))
    ...
    $filter="";
$_SESSION['currentpagelimit']=$_SESSION['TotalRecordsOnBrowseStuffPage'];
$pages = new Paginator();
$objPlBrowseStuff = new PlStuff();

$num_rows=$objPlBrowseStuff->PlTotalRecords($_SESSION['tag'],$filter);
if($num_rows>0)
{
...
$output = $objPlBrowseStuff->PlGetAllStuff($_SESSION['tag'],$limit,$filter,$relatedCategoryArray);
/* Browsing Stuff Ends Here */

//print_r($relatedCategoryArray);
/* Display All Tags */
$objPlTag=new PlTags();
...
<html dir="rtl" lang="he" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="dvMain" align="center">
			...
			{
			    echo "<div>Welcome to besthing.il <br> Look around and enjoy the stuff.</div>";
			}
			else
			{
                ...
                <div id="dvFilterSection">
                    <div id="dvFilters">
                        <?php
                            ...
                            $ipp=$_REQUEST['ipp'];
                        ?>
                        <a href="BrowseStuff.php?page=<?php echo $page; ?>&ipp=<?php echo $ipp; ?>&<?php echo $defaulttag; ?>&filter=created">created</a>
                        <a href="BrowseStuff.php?page=<?php echo $page; ?>&ipp=<?php echo $ipp; ?>&<?php echo $defaulttag; ?>&filter=popular">popular</a>
                        <a href="BrowseStuff.php?page=<?php echo $page; ?>&ipp=<?php echo $ipp; ?>&<?php echo $defaulttag; ?>&filter=active discussion">active discussions</a>
                    </div>
                    <div id="dvTopPaging">
                        <?php
                            if($num_rows>0)
