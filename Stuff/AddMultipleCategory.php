...
$objBo = new BoCategory();
/*for($i=0;$i<count($category);$i++)
{
    $objBo->setId($category[$i]);
    $objPlCategor = new PlCategory();
    $record=$objPlCategor->PlEditCategory($objBo);
    print_r ($record[0]['Title']);
}*/
//Business Object
...
<html dir="rtl" lang="he" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" language="JavaScript">
            ...
            {
                if(document.frmaddcategory.keyword.value.trim()=="")
                    return false;
                else
                    return true;
            }
    ...
    <body>
        <form name="frmaddcategory" method="POST" action="Newstuff.php" enctype="multipart/form-data" onsubmit="return CategoryValid();">
            <div id="dvMain" align="center">
                ...
                <span style='font-size: 1px;'>&nbsp;</span>
                <div id="dvAddStuff">
                    <table class="table" align="Right" width="290px">
                        <tr>
                            <th title="add category">Add Category</th>
                        </tr>
                        <tr>
                            <td>I think</td>
                        </tr>
                                    ...
                                    <div id="holder">
                                        <?php
                                            ...
                                            for($i=0;$i<count($category);$i++)
                                            {
                                                ...
                                                $record=$objPlCategory->PlEditCategory($objBo);
                                                $catlist[$i]=$record[0]['Title'];
                                            }

                                            echo "<b>".implode(",",$catlist)."</b>";
                                        ?>
                                        <!--<input style="font-family: Verdana, Arial, Helvetica, sans-serif;" type="text" name="keyword" id="keyword" value="<?php echo implode(",",$catlist); ?>" tabindex="0" style="width: 90%; direction: rlt;" OnKeyPress="return disableEnterKey(event);"/>
                                        <img src="images/loading.gif" id="loading" alt=""/>-->
                                        <input type="hidden" name="keyword" id="keyword" value="<?php echo implode(",",$catlist); ?>"/>
                                        <input type="hidden" name="categoryid" id="categoryid" value="<?php echo implode(",",$category); ?>"/>
                                    </div>
