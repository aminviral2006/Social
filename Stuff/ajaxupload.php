...
$_SESSION['savefile']="";;
	...
	if($filesize_image > 0)
        ...
        if($imgUploaded)
        {
            echo '<img src="../images/accept.jpg" width="16" height="16" border="0" style="marin-bottom: -4px;" /> Image Uploaded Successfully!';
            $stuffid=$_SESSION['stuffid'];
            $filename=$_SESSION['savefile'];
                        
            $objPlStuff=new PlStuff();
            $UploadImage=$objPlStuff->PlUploadImage($stuffid, $filename);            
	}
        else
        {
		echo '<img src="stuffimages/error.gif" width="16" height="16px" border="0" style="marin-bottom: -3px;" /> Error(s) Found: ';
